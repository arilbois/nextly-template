        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              I am currently working at Indonesian Railways Company as a web
              developer. I specialize in backend development using Spring Boot
              and Laravel. I believe in the power of adaptation, as I understand
              that learning everything is not feasible, but adapting to new
